...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% takshingchan 2015jun03.  Removed perm
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
SAR=zeros(nsrc,1);
for j=1:nsrc,
    [s_true,e_spat,e_interf,e_artif]=bss_decomp_mtifilt(se(j,:),s,j,512);
    [SDR(j),SIR(j),SAR(j)]=bss_source_crit(s_true,e_spat,e_interf,e_artif);
end
